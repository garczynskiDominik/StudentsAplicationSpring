    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <p class="mb-4">Wszyscy kursanci biorący udział w szkoleniu  | <a
                                ...
                                <c:forEach items="${person}" var="title">
                                    <tr>
                                        ...
                                        <td><a href="#" role="button" class="btn btn-success btn-circle"
                                               data-toggle="modal" data-target="#umiejetnosci${title.id}">
                                            <i class="fas
                                        fa-check"></i></a></td>
              ...
              font-weight-bold">Wzorce
                                                                projektowe
                                                                <span class="float-right">${title.bestpractice}%</span>
                                                            </h4>
                                                            <div class="progress mb-4">
                                                                <div class="progress-bar bg-warning" role="progressbar"
                                                                     style="width: ${title.bestpractice}%"
              ...
              font-weight-bold">Hibernate JPA
                                                                <span class="float-right">${title.hibernate}%</span>
                                                            </h4>
                                                            <div class="progress">
                                                                <div class="progress-bar bg-success" role="progressbar"
                                                                     style="width: ${title.hibernate}%"
              ...
              font-weight-bold">Thymeleaf
                                                                <span class="float-right">${title.thymeleaf}%</span>
                                                            </h4>
                                                            <div class="progress mb-4">
                                                                <div class="progress-bar bg-info" role="progressbar"
                                                                     style="width: ${title.thymeleaf}%"
                                                                     aria-valuenow="80" aria-valuemin="0"
                                                                     aria-valuemax="100"></div>
                                                            </div>
                                                            <h4 class="small
